...
class Bulletins extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            'rows' => $this->bulletinsmodel->get_by_level(1)
        );
    ...
    public function nationalbulletin($id)
    {
        ...
        $leadingdiseasetable .= '<tr bgcolor="#892A24" bordercolor="#892A24"><td><font color="#FFFFFF">Leading Diseases</font></td><td colspan="2"><font color="#FFFFFF">Epi week ' . $row->week_no . '</font></td><td colspan="2"><font color="#FFFFFF">Epi week ' . $epicalendar->week_no . '</font></td></tr>';
        ...
        foreach ($diseases as $key => $value) {
            ...
            if ($x > 3) {
                ...
                if ($key == $diseasekey[0]) {
                    ...
                    $prevsection                  = '<td>' . $previousdiseases['SARI'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[1]) {
                    ...
                    $prevsection                  = '<td>' . $previousdiseases['ILI'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[2]) {
                    ...
                    $prevsection                  = '<td>' . $previousdiseases['AWD'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[3]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['BD'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[4]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['OAD'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[5]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['Diph'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[6]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['WC'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[7]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['Meas'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[8]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['NNT'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[9]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['AFP'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[10]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['AJS'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[11]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['VHF'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[12]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['Mal'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                ...
                if ($key == $diseasekey[13]) {
                    ...
                    $prevsection = '<td>' . $previousdiseases['Men'] . '</td><td>' . number_format($prevdiseasepercentage, 1) . '%</td>';
                }
                
                $leadingdiseasetable .= '<tr><td>' . $key . '</td><td>' . $value . '</td><td>' . number_format($diseasepercentage, 1) . '%</td>' . $prevsection . '</td></tr>';
            }
        }
        
        //print_r($previousdiseases);
        
        $otherconsultations = ($totaldiseases - $totalleadingdiseases);
        if ($otherconsultations == 0) {
            $otherconsultpercentage = 0;
        } else {
            $otherconsultpercentage = ($otherconsultations / $totaldiseases) * 100;
        }
        
        $otherprevconsultations = ($totalprevdiseases - $totalleadingoreviousdiseases);
        if ($otherprevconsultations == 0) {
            $otherprevconsultationspercentage = 0;
        } else {
            $otherprevconsultationspercentage = ($otherprevconsultations / $totalprevdiseases) * 100;
        }
        
        $leadingdiseasetable .= '<tr><td>Other Consultations</td><td>' . $otherconsultations . '</td><td>' . number_format($otherconsultpercentage, 1) . '%</td><td>' . $otherprevconsultations . '</td><td>' . number_format($otherprevconsultationspercentage, 1) . '%</td></tr>';
        $leadingdiseasetable .= '<tr bgcolor="#892A24"><td><font color="#FFFFFF">Total Consultations</font></td><td><font color="#FFFFFF">' . $totaldiseases . '</font></td><td><font color="#FFFFFF">100%</font></td><td><font color="#FFFFFF">' . $totalprevdiseases . '</font></td><td><font color="#FFFFFF">100%</font></td></tr>';
