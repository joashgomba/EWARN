	   ...
	   //if(empty($reporting_year) || empty($reporting_year2) || empty($from) || empty($to) || empty($district_id)){
		...
		else
		{
			...
			else
			{
				...
				$lists = $this->formsmodel->get_full_list_level($reporting_year,$reporting_year2,$from,$to,$dist_id,$reg_id,$zn_id,$hf_id,$level);
   ...
   public function exportlist()
   {
	...
	$table .= '<thead>';
	  ...
	  endforeach;
		...
		$table .= '<th>unDis_name</th><th >unDis_num</th><th>unDis_name</th><th >unDis_num</th><th >OC</th><th>SRE</th><th>Pf</th>
								<th>Pv</th><th>Pmix</th><th>Cons</th><th>User</th><th>Validate</th></tr>';
		$table .= '</thead>';
		$table .= '<tbody>';
   }
