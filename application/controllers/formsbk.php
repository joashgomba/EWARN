   ...
   public function add_validate()
   {
	...
	public function update_form()
    {
		...
		if ($this->form_validation->run() == false) {
           ...
           redirect('forms/healthfacility','refresh');
                ...
                if (empty($reportingform)) {
					...
					<div class="row-fluid">
                        ...
                        <div class="row-fluid">
									...
									<div class="span4"><input type="text" name="undismale" id="undismale" value="' . $reportingform->undismale . '" onkeypress="return isNumberKey(event)" maxlength="5"></div>
                                    <div class="span4"><input type="text" name="undisfemale" id="undisfemale" value="' . $reportingform->undisfemale . '" onkeypress="return isNumberKey(event)" maxlength="5"></div>
						</div>
                        <hr>
                         <div class="row-fluid">
									<div class="span4"><input type="text" name="undissecdesc" id="undissecdesc" value="' . $reportingform->undissecdesc . '" ></div>
									<div class="span4"><input type="text" name="undismaletwo" id="undismaletwo" value="' . $reportingform->undismaletwo . '" onkeypress="return isNumberKey(event)" maxlength="5"></div>
                                    <div class="span4"><input type="text" name="undisfemaletwo" id="undisfemaletwo" value="' . $reportingform->undisfemaletwo . '" onkeypress="return isNumberKey(event)" maxlength="5"></div>
						</div>
                        ...
                        <div class="row-fluid">
									...
									<div class="span4"><input type="text" name="ocmale" id="ocmale" value="' . $reportingform->ocmale . '"></div>
                                    <div class="span4"><input type="text" name="ocfemale" id="ocfemale" value="' . $reportingform->ocfemale . '" onkeypress="return isNumberKey(event)" maxlength="5"></div>
						</div>
                        ...
                        <div class="row-fluid">
									...
									<div class="span4"><input type="text" name="total_consultations" id="total_consultations" value="' . $reportingform->total_consultations . '" readonly ="readonly"></div>
...
<div class="control-group"><label class="control-label" for="form-field-1">Slides/RDT examined: </label><div class="controls"><input type="text" name="sre" id="sre" value="' . $reportingform->sre . '" onkeypress="return isNumberKey(event)" maxlength="5"   />                           </div>
</div>

<div class="control-group"><label class="control-label" for="form-field-1">Falciparum positive: </label><div class="controls"><input type="text" name="pf" id="pf" value="' . $reportingform->pf . '" onkeypress="return isNumberKey(event)" maxlength="5"   />                              </div>
</div>

<div class="control-group"><label class="control-label" for="form-field-1">Vivax positive: </label><div class="controls"><input type="text" name="pv" id="pv" value="' . $reportingform->pv . '" onkeypress="return isNumberKey(event)" maxlength="5"   />                              </div>
</div>

<div class="control-group"><label class="control-label" for="form-field-1">Mixed Positive: </label><div class="controls"><input type="text" name="pmix" id="pmix" value="' . $reportingform->pmix . '" onkeypress="return isNumberKey(event)" maxlength="5"   />                              </div>
</div>
