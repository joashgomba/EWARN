...
<title>Weekly National Online Bulletin - <?php echo $row->issue_no;?> Epi Week <?php echo $row->week_no;?></title>
<style>
				#lasttable
				{
...
<tr><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Leading diseases in Somalia (Epi week <?php echo $row->week_no;?>)</strong></font></td><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Alerts and outbreaks - Epi Week <?php echo $row->week_no;?></strong></font></td></tr>
<tr><td valign="top">
...
<tr bgcolor="#892A24">
<td valign="top"><font color="#FFFFFF"><strong>Trends for confirmed Malaria morbidity in Somalia</strong></font></td><td valign="top"><font color="#FFFFFF"><strong>Summary of malaria morbidity in week <?php echo $row->week_no;?></strong></font></td>
</tr>
<tr>
  <td valign="top">
