...
.display td:nth-of-type(4):before { content: "Period From"; }
.display td:nth-of-type(5):before { content: "Period To"; }
.display td:nth-of-type(6):before { content: "Issue No"; }
.display td:nth-of-type(7):before { content: "Creation Date Time"; }
.display td:nth-of-type(8):before { content: "Actions"; }
		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				<div class="page-content">
                    ...
                    <?php
					if($level ==1 || $level ==2 || $level==3 || $level==5 || $level==6)
					{
						//show nothing
					}
					else
					...
					?>
                    <p>
                    <a href="<?php echo base_url() ?>index.php/bulletins/add" class="btn btn-app btn-primary no-radius">
...
<?php
					...
					{
					?>
<a href="<?php echo base_url() ?>index.php/bulletins/edit/<?php echo $row->id; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
																	<span class="green">
