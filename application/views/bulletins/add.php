...
function CheckAvailability(frm){
	...
	var url = "<?php echo base_url(); ?>/index.php/bulletins/checkavailability";
	
	var params = "week_year=" + totalEncode(document.frm.week_year.value ) + "&week_no="+totalEncode(document.frm.week_no.value ) + "&level="+totalEncode(document.frm.level.value );
...
echo form_open('bulletins/add_validate',$attributes); ?>
<table id="customers">
