...
<title>Weekly National bulletin - <?php echo $row->issue_no;?> Epi Week <?php echo $row->week_no;?></title>
<style>
				#listtable
				{
...
<tr><th><center>Issue <?php echo $row->issue_no;?>, Epi Week <?php echo $row->week_no;?>, <?php echo date("d F Y", strtotime($row->period_from)); ?> - <?php echo date("d F Y", strtotime($row->period_to)); ?></center></th></tr>
<tr><td>
<table id="customers">
<tr><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Highlights</strong></font></td><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Reporting rates vs consultations in Somalia, Epi Weeks <?php echo $startingweek;?> to <?php echo $row->week_no;?> - <?php echo $row->week_year;?></strong></font></td></tr>
<tr><td valign="top">
...
<hr />
<p><center><font size="-1" color="#1F7EB8">Reporting Rates by Zones(Epi-week <?php echo $row->week_no;?>, <?php echo $row->week_year;?>)</font></center></p>
<div id="distributioncontainer" style="min-width:200px; height: 210px; margin: 0 auto"></div>

</td></tr>
<tr><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Leading diseases in Somalia (Epi week <?php echo $row->week_no;?>)</strong></font></td><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Alerts and outbreaks - Epi Week <?php echo $lastthreeweeks;?> to <?php echo $row->week_no;?></strong></font></td></tr>
<tr><td valign="top">
...
$(function () {
    ...
    $(document).ready(function() {
      ...
      enabled: false
        ...
        <div id="trendscontainer" style="min-width: 300px; height: 250px; margin: 0 auto"></div>
...
$(function () {
    ...
    $(document).ready(function() {
      ...
      enabled: false
        ...
        <tr bgcolor="#892A24"><td colspan="2"><font color="#FFFFFF" size="-2">*Epi=Epidemiological; Sus=Suspected; AFP=Acute Flaccid Paralysis; NNT=Neonatal Tetanus; HF=Health Facility; WPV = Wild Polio Virus; CSR=Communicable disease Surveillance and ResponseI; INT=Insecticides Treated Nets</font></td></tr>
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            yAxis: {
                min: 0,
                title: {
                    text: 'Number of Reported Alerts'
                }
            },  credits: {
      enabled: false
  },/**
        ...
        <div id="container_sect" style="min-width: 300px; height: 250px; margin: 0 auto"></div>
...
<tr bgcolor="#892A24">
<td valign="top"><font color="#FFFFFF"><strong>Trends for confirmed Malaria morbidity in Somalia</strong></font></td><td valign="top"><font color="#FFFFFF"><strong>Alerts/outbreaks investigations and response in week <?php echo $row->week_no;?></strong></font></td>
</tr>
<tr>
  <td valign="top">
 <script type="text/javascript">
$(function () {
    ...
    $(document).ready(function() {
      ...
      enabled: false
        ...
        <div id="malariacontainer" style="min-width: 300px; height: 300px; margin: 0 auto"></div>
...
<tr bgcolor="#892A24"><td colspan="2"><font color="#FFFFFF"><strong>Distribution of consultations of leading diseases by zone, Epiweek <?php echo $row->week_no;?></strong></font></td></tr>
...
<tr bgcolor="#892A24"><td><font color="#FFFFFF"><strong>Alerts/Outbreaks Reported in Epi Week <?php echo $row->week_no;?>, <?php echo $row->week_year;?></strong></font></td></tr>
<tr ><td colspan="2">
<?php echo $alertstable; ?>
</td></tr>
</table>
</td></tr>
 <tr bgcolor="#892A24"><td><font color="#FFFFFF" size="-2">*Epi=Epidemiological; Sus=Suspected; AFP=Acute Flaccid Paralysis; NNT=Neonatal Tetanus; HF=Health Facility; WPV = Wild Polio Virus; CSR=Communicable disease Surveillance and ResponseI; INT=Insecticides Treated Nets</font></td></tr>
 <tr bgcolor="#1F7EB8 "><td><font color="#FFFFFF" size="-2">This weekly Epidemiological bulletin is published jointly by the Health Authorities and the World Health Organization. For further information, please contact the surveillance team on: ajangaa@nbo.emro.who.int</font></td></tr>
</table>
