	...
	<body>
		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				?>
<?php echo form_open('bulletins/edit_zonal_validate/'.$row->id); ?>
<div class="control-group"><label>Zone: </label><div class="controls"><strong><?php echo $zone->zone; ?></strong></div>
</div>
