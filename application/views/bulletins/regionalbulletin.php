...
<title>Weekly <?php echo $region->region;?> Region Online Bulletin - <?php echo $row->issue_no;?> Epi Week <?php echo $row->week_no;?></title>
<style>
				#lasttable
				{
...
<tr><th><center><?php echo $region->region;?>, Issue <?php echo $row->issue_no;?>, Epi Week <?php echo $row->week_no;?>, <?php echo date("d F Y", strtotime($row->period_from)); ?> - <?php echo date("d F Y", strtotime($row->period_to)); ?></center></th></tr>
<tr><td>
<table id="customers">
<tr><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Highlights</strong></font></td><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Reporting rates vs consultations in <?php echo $region->region;?>, Epi Weeks <?php echo $startingweek;?> to <?php echo $row->week_no;?> - <?php echo $row->week_year;?></strong></font></td></tr>
<tr><td valign="top">
...
<hr />
<p><center>
  <font size="-1" color="#1F7EB8">Reporting Rates by Districts (Epi-week <?php echo $row->week_no;?>, <?php echo $row->week_year;?>)</font>
</center></p>
<div id="distributioncontainer" style="min-width:200px; height: 210px; margin: 0 auto"></div>

</td></tr>
<tr><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Leading diseases in <?php echo $region->region;?> (Epi week <?php echo $row->week_no;?>)</strong></font></td><td bgcolor="#892A24" width="50%"><font color="#FFFFFF"><strong>Alerts and outbreaks - Epi Week <?php echo $row->week_no;?></strong></font></td></tr>
<tr><td valign="top">
...
<tr bgcolor="#892A24"><td width="50%"><font color="#FFFFFF"><strong>Number of alerts received and reported (Epiweeks <?php echo $period_three;?> to <?php echo $row->week_no;?> - <?php echo $row->week_year;?>)</strong></font></td><td width="50%"><font color="#FFFFFF"><strong>Age and sex distribution of diseases by cases (Epiweek <?php echo $row->week_no;?>, <?php echo $row->week_year;?>)</strong></font></td></tr>
<tr><td valign="top">
<script type="text/javascript">
$(function () {
    var chart;
...
<tr bgcolor="#892A24">
<td valign="top" width="50%"><font color="#FFFFFF"><strong>Trends for confirmed Malaria morbidity in <?php echo $region->region;?></strong></font></td><td valign="top" width="50%"><font color="#FFFFFF"><strong>Summary of malaria morbidity in week <?php echo $row->week_no;?></strong></font></td>
</tr>
<tr>
  <td valign="top">
