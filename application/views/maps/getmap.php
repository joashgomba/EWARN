 ...
 else
 {
   ...
   <select name="healthfacility_id" id="healthfacility_id">
           ...
           <?php
			...
			{
			?>
              <option value="<?php echo $healthfacility['id'];?>" <?php if(set_value('healthfacility_id')==$healthfacility['id']){echo 'selected="selected"';}?>><?php echo $healthfacility['health_facility'];?></option>
            <?php
			}
			?>
    </select>   
...
<option value="0" <?php if(set_value('verification_status')==0){echo 'selected="selected"';}?>>Not Verified</option>
<option value="1" <?php if(set_value('verification_status')==1){echo 'selected="selected"';}?>>Verified</option>
