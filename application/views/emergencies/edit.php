...
<?php echo form_open('emergencies/edit_validate/'.$row->id,$attributes); ?>
...
<select name="zone_id" id="zone_id" disabled="disabled">
                                
                                <?php
								foreach($zones as $key=> $zone)
								{
									?>
                                    <option value="<?php echo $zone['id'];?>" <?php if($row->zone_id==$zone['id']){echo 'selected="selected"';}?>><?php echo $zone['zone'];?></option>
                                    <?php
								}
								?>
                                </select>
...
<div class="control-group"><label class="control-label" for="form-field-1"><?php echo $user_country->second_admin_level_label;?>: </label><div class="controls">
							<select name="region_id" id="region_id" disabled="disabled">
									...
									{
									?>
                                    <option value="<?php echo $region['id'];?>" <?php if($row->region_id==$region['id']){echo 'selected="selected"';}?>><?php echo $region['region'];?></option>
                                    <?php
									}
									?>
                                    </select>
...
<div class="control-group"><label class="control-label" for="form-field-1"><?php echo $user_country->third_admin_level_label;?>: </label><div class="controls">
 ...
 <select name="district_id" id="district_id" disabled="disabled">
...
<div class="control-group"><label class="control-label" for="form-field-1">Health facility</label><div class="controls">
 ...
 <select name="healthfacility_id" id="healthfacility_id" disabled="disabled">
                                  <?php
...
<input type="hidden" name="year_no" id="year_no" value="<?php echo $row->reporting_year;?>">
<input type="hidden" name="week_no" id="week_no" value="<?php echo $row->week_no;?>">
<select name="reporting_year" id="reporting_year" disabled="disabled">
                                 <?php
     $currentYear = date('Y')+10;
        foreach (range(2012, $currentYear) as $value) {
          ?>
                                 <option value="<?php echo $value;?>" <?php 
		   if($value==$row->reporting_year)
		   {
...
?>
                             ...
                             <select name="weekno" id="weekno" disabled="disabled">
...
<select name="disease_id" id="disease_id" disabled="disabled">
                                 <?php
    
        foreach ($diseases->result() as $disease) {
          ?>
        <option value="<?php echo $disease->id;?>" <?php 
		   if($disease->id==$row->disease_id)
		   {
			   echo 'selected="selected"';
		   }
...
?>
<option value="0" <?php if($row->disease_id==0){ echo 'selected="selected"';}?>>(UnDis) Other Unusual Disease</option>
                               </select>
...
<?php if($row->disease_id==0){?>
<div class="control-group">
									<label class="control-label" for="form-field-5">Description</label>

									<div class="controls">
                                    <input class="span5" type="text" name="other" id="other"  onFocus="change(this,'#FF0000','#FFCCFF','#000000')" value="<?php echo $row->other;?>" onBlur="change(this,'','','')" disabled="disabled" />
                                    </div>
...
<div class="control-group">
									...
									<div class="controls">
										<input class="span5" type="text" name="male_under_five" id="male_under_five"   onkeypress="return isNumberKey(event)" maxlength="2" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Male" value="<?php echo $row->male_under_five;?>" required="required"/>
										<input class="span5" type="text" name="female_under_five" id="female_under_five"  onkeypress="return isNumberKey(event)" maxlength="2" onFocus="change(this,'#FF0000','#FFCCFF','#000000')" onBlur="change(this,'','','')" placeholder="Female" value="<?php echo $row->female_under_five;?>" required="required"/>
...
<div class="control-group">
									...
									<div class="controls">
										<input class="span5" type="text" name="male_over_five" id="male_over_five"   onkeypress="return isNumberKey(event)" maxlength="2" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Male" value="<?php echo $row->male_over_five;?>" required="required"/>
										<input class="span5" type="text" name="female_over_five" id="female_over_five"  onkeypress="return isNumberKey(event)" maxlength="2" onFocus="change(this,'#FF0000','#FFCCFF','#000000')" onBlur="change(this,'','','')" placeholder="Female" value="<?php echo $row->male_over_five;?>" required="required" />
...
<div class="control-group">
									...
									<div class="controls">
										<input class="span5" type="text" name="death" id="death"   onkeypress="return isNumberKey(event)" maxlength="2" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="No. of Deaths" value="<?php echo $row->death;?>" required="required" />
...
<div class="control-group">
									...
									<div class="controls">
										<input  class="span5" name="reporting_date" onFocus="change(this,'#FF0000','#FFCCFF','#000000')" onBlur="change(this,'','','')" disabled="disabled" value="<?php echo $row->reporting_date;?>" />
...
<div class="control-group">
									<label class="control-label" for="form-field-5">Verification Status</label>
...
<div class="control-group">
									...
									<div class="controls">
										<textarea name="action_taken" id="action_taken"><?php echo $row->action_taken;?></textarea>
