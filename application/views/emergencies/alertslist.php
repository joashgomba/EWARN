...
function GetPeriod(frm){
	...
	var url = "<?php echo base_url(); ?>index.php/emergencies/getlist";
			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Emergency Alerts</li>
					</ul><!--.breadcrumb-->
...
<div class="control-group"><label class="control-label" for="form-field-1">Week No.: </label><div class="controls">
 <select name="week_no" id="week_no" onChange="GetPeriod(this)">
                            <option value="">Select Week</option>
							   ...
							   {
								   ?>
                                   <option value="<?php echo $i;?>" <?php if($week_no==$i){echo 'selected="selected"';}?>>Week <?php echo $i;?></option>
                                   <?php
							   }
							   ?>
                               </select>
