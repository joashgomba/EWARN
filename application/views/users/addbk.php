				...
				?>
					  ...
					  echo form_open('users/add_validate',$attributes); ?>
                       ...
                       <table id="customers">
                               ...
                               <tbody>
                               <tr><td>Registration Type</td><td><select name="level" id="level" onChange="showDiv(this.value);">
...
<div class="control-group"><label class="control-label" for="form-field-1">Health Facility code:  </label><div class="controls"><input type="text" name="hfcode" id="hfcode"><input type="button" value="FIND" onClick="GetHelathfacility(this)"></div>
</div>
</div>

</td></tr>
<tr><td colspan="2">
<div id="healthfacility"><input type="hidden" name="healthfacility_id" id="healthfacility_id"></div></td></tr>
<tr>
...
?>
								...
								<tr>
								  <td><?php echo $user_country->first_admin_level_label;?> <span class="red">*</span></td><td><select name="zone_id" id="zone_id" onChange="GetRegions(this)">
                                ...
                                <tr><td>Email</td><td><input type="text" name="email" id="email" value="<?php echo set_value('email'); ?>"></td></tr>
                                ...
                                <tr><td>Access Rights</td><td><select name="role_id" id="role_id">
<?php
