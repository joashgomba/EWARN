					...
					<div class="page-content">
						<div class="row-fluid">
							<div class="span12">
								...
								<p>
									<a href="<?php echo base_url() ?>formsdata/add" class="btn btn-app btn-primary no-radius">
...
<td><a href="<?php echo base_url() ?>formsdata/edit/<?php echo $row->id; ?>" class="tooltip-success" data-rel="tooltip" title="Edit">
 <span class="green">
 <i class="icon-edit bigger-120"></i>

																	</span></a>&nbsp;&nbsp;<a href="<?php echo base_url() ?>formsdata/delete/<?php echo $row->id; ?>" class="tooltip-error" data-rel="tooltip" title="Delete" onClick="return confirm('Are you sure you want to delete? This action is not reversable')">
 <span class="red">
