...
<?php echo form_open('formsdata/add_validate',$attributes); ?>
<div class="control-group"><label class="control-label" for="form-field-1">Form id: </label><div class="controls"><?php $data = array('id' => 'form_id', 'name' => 'form_id'); echo form_input($data, set_value('form_id')); ?></div>
