    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Weekly Disease Trends By Disease</li>
            </ul><!--.breadcrumb-->
        ...
        <div class="page-content">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="page-header position-relative">
                        <h1>
                            ...
                            <small>
                                ...
                                Weekly Disease Trends By Disease</small>
                        </h1>
                    </div><!--/.page-header-->
                    <?php
                    ...
                    echo form_open('analytics/diseasetrendreport',$attributes); ?>
                    ...
                    <div id="accordion2" class="accordion">
                                                        ...
                                                        <div class="control-group"><label class="control-label" for="form-field-1">Disease: </label><div class="controls">
                                                                <select name="disease_id" id="disease_id">
                                                                    ...
                                                                    foreach ($diseases->result() as $disease):
                                                                        ...
                                                                        ?>><?php echo $disease->disease_name;?> (<?php echo $disease->disease_code;?>)</option>
                        ...
                        <div class="widget-box">
                            <div class="widget-header widget-header-flat">
                                <h4>Weekly disease trends of <?php echo $mydisease->disease_name;?> week <?php echo $from;?> to  <?php echo $to;?>, <?php echo $reporting_year;?>  &amp; <?php echo $previous_year;?></h4>
                            </div>
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-flat">
                                    <h4>Weekly trends of <?php echo $mydisease->disease_name;?> from week <?php echo $from;?> to  <?php echo $to;?>, <?php echo $reporting_year;?>  &amp; <?php echo $previous_year;?></h4>
                                </div>
                                    ...
                                    <div class="widget-main">
                                        <div class="row-fluid">
                                            <div class="span12">
                                                ...
                                                echo form_open('analytics/exportdiseasetrend',$attributes); ?>
                                                ...
                                                <input type="hidden" name="mydisease_id" value="<?php  echo $disease_id;?>">
