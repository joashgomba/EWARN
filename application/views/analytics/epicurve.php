    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"> Diseases EPI Curve</li>
            </ul><!--.breadcrumb-->
        ...
        <div class="page-content">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    echo form_open('analytics/epicurve',$attributes); ?>
                        ...
                        <div id="accordion2" class="accordion">
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-flat">
                                    <h4>EPI Curve for Diseases from <?php echo $reporting_year;?> week <?php echo $from;?> to <?php echo $reporting_year2;?> week <?php echo $to;?></h4>
                                </div>
                                ...
                                <div class="widget-box">
                                    <div class="widget-header widget-header-flat">
                                        <h4>Breakdown of diseases from <?php echo $reporting_year;?> week <?php echo $from;?> to <?php echo $reporting_year2;?> week <?php echo $to;?></h4>
                                    </div>
