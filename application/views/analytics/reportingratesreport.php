    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Reporting Rate and Consultations</li>
            </ul><!--.breadcrumb-->
        ...
        <div class="page-content">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="page-header position-relative">
                        <h1>
                            ...
                            <small>
                                ...
                                Reporting Rate and Consultations</small>
                        </h1>
                    </div><!--/.page-header-->
                    <?php
                    ...
                    echo form_open('analytics/reportingratesreport',$attributes); ?>
                        ...
                        <div id="accordion2" class="accordion">
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-flat">
                                    <h4>Total consultations and reporting rates by EPI week <?php echo $from;?> <?php echo $reporting_year;?> to week <?php echo $to;?> <?php echo $reporting_year2;?></h4>
                                </div>
                                                ...
                                                $(function () {
                                                    ...
                                                    $(document).ready(function() {
                                                        chart = new Highcharts.Chart({
                                                            ...
                                                            title: {
                                                                text: 'Total consultations and reporting rates week <?php echo $from; ?> <?php echo $reporting_year; ?> to week <?php echo $to; ?> <?php echo $reporting_year2; ?>'
                                                            },
                                                            credits: {
                                                                enabled: false
                                                            },
                                                            ...
                                                            yAxis: [{ // Primary yAxis
                                                                ...
                                                                title: {
                                                                    ...
                                                                    width:2,
                                                                    zIndex:4,
                                                                    label:{text:'Completeness Cut-Off Point'}
                                                                }]
                                                            }, { // Secondary yAxis
                                                                title: {
                                                                    text: 'Consultations',
                                ...
                                <div class="widget-box">
                                    <div class="widget-header widget-header-flat">
                                        <h4>Breakdown of reporting rates and consultations from <?php echo $reporting_year;?> week <?php echo $from;?> to <?php echo $reporting_year2;?> week <?php echo $to;?></h4>
                                    </div>
                                        ...
                                        <div class="widget-main">
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    ...
                                                    echo form_open('analytics/exportreportingrates',$attributes); ?>
