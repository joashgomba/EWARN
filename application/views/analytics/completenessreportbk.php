    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Timelyness and Completeness</li>
            </ul><!--.breadcrumb-->
                    ...
                    <div class="page-header position-relative">
                        <h1>
                            ...
                            <small>
                                ...
                                Timelyness and Completeness</small>
                        </h1>
                    </div><!--/.page-header-->
                    <?php
                    ...
                    echo form_open('analytics/completenessreport',$attributes); ?>
                        ...
                        <div id="accordion2" class="accordion">
                            ...
                            <div class="widget-box">
                                ...
                                <!--<div class="widget-box">
                                    <div class="widget-header widget-header-flat">
                                        <h4>Breakdown of reporting sites from <?php echo $reporting_year;?> week <?php echo $from;?> to <?php echo $reporting_year2;?> week <?php echo $to;?></h4>
                                    </div>
