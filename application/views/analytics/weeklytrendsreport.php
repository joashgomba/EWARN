    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Weekly Disease Trends By Disease Category</li>
            </ul><!--.breadcrumb-->
        ...
        <div class="page-content">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="page-header position-relative">
                        <h1>
                            ...
                            <small>
                                ...
                                Weekly Disease Trends By Disease Category</small>
                        </h1>
                    </div><!--/.page-header-->
                    <?php
                    ...
                    echo form_open('analytics/weeklytrendsreport',$attributes); ?>
                    ...
                    <div id="accordion2" class="accordion">
                                  ...
                                  <?php
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span6">
                                                        ...
                                                        <div class="control-group"><label class="control-label" for="form-field-1">Disease Category: </label><div class="controls">

                                                                <select name="diseasecategory_id" id="diseasecategory_id">
                                                                    <?php
                                                                    foreach ($diseasecategories as $key=>$diseasecategory):
                                                                        ?>
                                                                        <option value="<?php echo $diseasecategory['id'];?>" <?php
                                                                        if($diseasecategory['id']==set_value('diseasecategory_id'))
                                                                        {
                                                                            echo 'selected="selected"';
                                                                        }
                                                                        ?>><?php echo$diseasecategory['category_name'];?></option>
                        ...
                        <div class="widget-box">
                            <div class="widget-header widget-header-flat">
                                <h4>Weekly disease trends of <?php echo $thecategory->category_name;?> week <?php echo $from;?> to  <?php echo $to;?>, <?php echo $reporting_year;?>  &amp; <?php echo $previous_year;?></h4>
                            </div>
                            ...
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="row-fluid">
                                            ...
                                            $(function () {
                                                ...
                                                $(document).ready(function() {
                                                    chart = new Highcharts.Chart({
                                                        ...
                                                        title: {
                                                            text: 'Weekly disease trends of <?php echo $thecategory->category_name;?> week <?php echo $from;?> to  <?php echo $to;?>, <?php echo $reporting_year;?>  & <?php echo $previous_year;?>'
                                                        },
                                                        subtitle: {
                                                            text: ''
                                                        },
                                        ...
                                        <div id="respcontent" style="min-width: 100%; height: 400px; margin: 0 auto"></div>
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-flat">
                                    <h4>Weekly trends of <?php echo $thecategory->category_name;?> from week <?php echo $from;?> to  <?php echo $to;?>, <?php echo $reporting_year;?>  &amp; <?php echo $previous_year;?></h4>
                                </div>
                                    ...
                                    <div class="widget-main">
                                        <div class="row-fluid">
                                            <div class="span12">
                                                ...
                                                echo form_open('analytics/exportweeklytrend',$attributes); ?>
                                                ...
                                                <input type="hidden" name="mydiseasecategory_id" value="<?php  echo $diseasecategory_id;?>">
