    ...
    <div class="main-content">
        <div class="breadcrumbs" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Consultations vs Reporting Sites</li>
            </ul><!--.breadcrumb-->
        ...
        <div class="page-content">
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <div class="page-header position-relative">
                        <h1>
                            ...
                            <small>
                                ...
                                Consultations vs Reporting Sites</small>
                        </h1>
                    </div><!--/.page-header-->
                    <?php
                    ...
                    echo form_open('analytics/consultationsreport',$attributes); ?>
                        ...
                        <div id="accordion2" class="accordion">
                            ...
                            <div class="widget-box">
                                <div class="widget-header widget-header-flat">
                                    <h4>Total consultations and number of reporting sites by EPI week <?php echo $from;?> <?php echo $reporting_year;?> to week <?php echo $to;?> <?php echo $reporting_year2;?></h4>
                                </div>
                                                ...
                                                $(function () {
                                                    ...
                                                    $(document).ready(function() {
                                                        chart = new Highcharts.Chart({
                                                            ...
                                                            title: {
                                                                text: 'Total consultations and number of reporting sites week <?php echo $from; ?> <?php echo $reporting_year; ?> to week <?php echo $to; ?> <?php echo $reporting_year2; ?>'
                                                            },
                                                            credits: {
                                                                enabled: false
                                                            },
                                ...
                                <div class="widget-box">
                                    <div class="widget-header widget-header-flat">
                                        <h4>Breakdown of reporting sites and consultations from <?php echo $reporting_year;?> week <?php echo $from;?> to <?php echo $reporting_year2;?> week <?php echo $to;?></h4>
                                    </div>
