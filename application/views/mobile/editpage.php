...
<div class="form">
<form id="frm" name="frm" action="" method="post" onSubmit="return(validate())">
<?php
foreach($diseasecategories as $key=>$diseasecategory):
...
<div id="HeaderTableStep<?php echo $lastheader;?>" style="background-color:Silver; display: inline-block"><h3>Finish</h3></div>
	...
	if($row->approved_dist==1)
	{
		?>
  <div class="intro">
  THE FORM HAS BEEN APPROVED AT SECOND LEVEL OF APPROVAL. YOU CAN THEREFORE ONLY VIEW THE DATA BUT YOU CANNOT EDIT.
  </div>  
  <?php
	}
	?>
 <div class="intro"> <div align="left"><label>Reporting Year</label>
 <select name="reporting_year" id="reporting_year" onChange="GetPeriod(this)" disabled="disabled">
...
?>
                               ...
                               <label>Week No.</label>
<select name="week_no" id="week_no" onChange="GetPeriod(this)" disabled="disabled">
...
$categorydiseases = $this->formsmodel->get_by_facility_category_data($row->id,$diseasecategory['id'],$limit);
...
?>
 ...
 <label>MALE</label>
 <input type="text" id="<?php echo $categorydisease->disease_code;?>_ufive_male" name="<?php echo $categorydisease->disease_code;?>_ufive_male" onKeyPress="return isNumberKey(event)" maxlength="5" value="<?php echo $categorydisease->male_under_five; ?>" />
          </li>
         <li>
  <label>FEMALE</label>
 <input type="text" id="<?php echo $categorydisease->disease_code;?>_ufive_female" name="<?php echo $categorydisease->disease_code;?>_ufive_female" onKeyPress="return isNumberKey(event)" maxlength="5" value="<?php echo $categorydisease->female_under_five; ?>"/>
         </li>
         <h3><?php echo $categorydisease->disease_code;;?> >= 5yr</h3>
         <li>
 <!---->
 ...
 <label>MALE</label>
 <input type="text" id="<?php echo $categorydisease->disease_code;?>_ofive_male" name="<?php echo $categorydisease->disease_code;?>_ofive_male" onKeyPress="return isNumberKey(event)" maxlength="5" value="<?php echo $categorydisease->male_over_five; ?>"/>
         </li>
         <li>
  <label>FEMALE</label>
 <input type="text" id="<?php echo $categorydisease->disease_code;?>_ofive_female" name="<?php echo $categorydisease->disease_code;?>_ofive_female" onKeyPress="return isNumberKey(event)" maxlength="5" value="<?php echo $categorydisease->female_over_five; ?>"/>
         </li>
