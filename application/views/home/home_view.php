			...
			<div class="main-content">
                ...
                <div class="row-fluid">
						<div class="span8">
                            ...
                            <h4 class="header smaller lighter blue">Alerts Map week <?php echo $current_week; ?> <?php echo $current_year; ?></h4>
...
//kmzLayer.setMap(map);
  ...
  if( typeof(latlong) === 'undefined') {
    ...
    geocoder.geocode({
      'address': '<?php echo $country->map_center; ?>'
    ...
    marker = new google.maps.Marker({
      ...
      position: latlong
                        ...
                        <div class="span4">
                            ...
                            <h4 class="header smaller lighter blue">Alerts week <?php echo $current_week; ?> <?php echo $current_year; ?></h4>
...
<?php echo $alert_list; ?>                                                            
                 ...
                 <div class="row-fluid">
						<div class="span12" style="overflow: auto">
                            ...
                            <div class="widget-box">
										<div class="widget-header">
                                           ...
                                           Immediate Notifications/Daily Alerts 
											</h4>
										</div>
                    ...
                    <div class="alert alert-info">
                        ...
                        The reports presented on this page are summarised based on the data collected over a period not exceeding 10 EPI weeks from the current week. For a detailed breakdown and analysis of the
                        data, got to the Data Analytics section.
                        <br />
                    </div>
						...
						<div class="span6">
                            ...
                            <div class="widget-box">
										<div class="widget-header">
                                           ...
                                           PERCENTAGE OF REPORTED CASES BY AGE WEEK <?php echo $current_week; ?> <?php echo $current_year; ?> 
											</h5>
										</div>
...
$(function () {
    ...
    $(document).ready(function () {
        ...
        chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Percentage of reported cases by age week <?php echo $current_week; ?> <?php echo $current_year; ?>'
            },
            tooltip: {
                        ...
                        <div class="span6">
                            ...
                            <div class="widget-box">
										<div class="widget-header">
                                           ...
                                           PERCENTAGE OF REPORTED CASES BY SEX WEEK <?php echo $current_week; ?> <?php echo $current_year; ?> 
											</h5>
										</div>
...
$(function () {
    ...
    $(document).ready(function () {
        ...
        chart = new Highcharts.Chart({
            ...
            title: {
                text: 'Percentage of reported cases by sex week <?php echo $current_week; ?> <?php echo $current_year; ?>'
            },
            tooltip: {
        	    pointFormat: '{series.name}: <b>{point.percentage}%</b>',
            	percentageDecimals: 1
						...
						<div class="span12" style="overflow: auto">
                            ...
                            <div class="widget-box">
										<div class="widget-header">
                                            ...
                                            EPI Curve for Diseases of interest
											</h4>
										</div>
...
$(function () {
    ...
    $(document).ready(function() {
        chart = new Highcharts.Chart({
            ...
            xAxis: {
                categories: [<?php echo $interestcategory; ?>]
            },
            yAxis: {
				min: 0, 
                title: {
										 ...
										 if($level==3)//HF
										   {
											  	...
											  	$administrative_region =  $healthfacility->health_facility;							   
										   }
										 if($level==6)//District
										   {
										  ...
										  if($level==2)//FP
										   ...
										   if($level==5)//stakeholder
										   {
											...
											?>
												Weekly Disease Cases for <?php echo $administrative_region;?> for the previous four (4) weeks
											</h4>
										</div>
                    ...
                    <div class="row-fluid">
						<div class="span12">
                            ...
                            <div class="widget-box">
										<div class="widget-header">
											<h4 class="smaller">
												Weekly Disease Cases from week <?php echo $from_week; ?> <?php echo $from_year; ?>  to week <?php echo $current_week; ?> <?php echo $current_year; ?> 
											</h4>
										</div>
...
$(function () {
    ...
    $(document).ready(function() {
        ...
        options = {
            ...
            title: {
                text: 'Weekly Disease Cases <?php echo $administrative_region;?> wk <?php echo $from_week; ?> <?php echo $from_year; ?> to wk <?php echo $current_week; ?> <?php echo $current_year; ?>'
            },
            xAxis: {
            },
            yAxis: {
