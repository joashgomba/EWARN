...
function checkvalid()
{
   ...
   if( document.frm.period_check.value == "")
   {
     alert( "There are no reporting periods added." );
     document.frm.reporting_year.focus();
     return false;
   }
}
...
var <?php echo $disease->disease_code;?>_ufive_male;
   ...
   if( document.frm.total_consultations.value != totalconsultations )
   {
	...
	if( document.frm.country_diseases.value == 0)
   {
     alert( "The reporting form cannot be submitted as the country does not have diseases added." );
  ...
  if( document.frm.district_id.value == "" )
   {
     alert( "Please enter the third administrative level." );
...
<?php
                              ...
                              <strong><?php echo $district->district;?></strong>
                                  <?php
							  }
							  else
							  {
...
<select name="reporting_year" id="reporting_year" onChange="GetPeriod(this)" required="required">
...
<select name="week_no" id="week_no" onChange="GetPeriod(this)" required="required">
...
<div id="reporingperiods">
 ...
 <input type="hidden" name="country_diseases" id="country_diseases" value="<?php echo $country_diseases;?>">
 <?php
...
<div class="widget-box">
					...
					<div class="row-fluid">
						...
						if($country_diseases==0)
						{
							?>
                              <div class="alert alert-danger">
										...
										This form will not be submitted as no diseases have been added for the country.
										<br />
									</div>
                        ...
                        <div class="control-group">
									<label class="control-label" for="form-field-5"><?php echo $disease->disease_name;?> &lt; 5</label>

									<div class="controls">
										<input class="span5" type="text" name="<?php echo $disease->disease_code;?>_ufive_male" id="<?php echo $disease->disease_code;?>_ufive_male"   onkeypress="return isNumberKey(event)" maxlength="2" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Male" onClick="checkvalid()" />
										<input class="span5" type="text" name="<?php echo $disease->disease_code;?>_ufive_female" id="<?php echo $disease->disease_code;?>_ufive_female"  onkeypress="return isNumberKey(event)" maxlength="2" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Female" />
                                        
                                        <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="<?php echo $disease->case_definition;?>." title="Case definition">?</span>
									</div>
								</div>
                                 ...
                                 <div class="control-group">
									...
									<div class="controls">
										<input class="span5" type="text" name="<?php echo $disease->disease_code;?>_ofive_male" id="<?php echo $disease->disease_code;?>_ofive_male"   onkeypress="return isNumberKey(event)" maxlength="5" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Male" />
										<input class="span5" type="text" name="<?php echo $disease->disease_code;?>_ofive_female" id="<?php echo $disease->disease_code;?>_ofive_female"  onkeypress="return isNumberKey(event)" maxlength="5" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Female" />
									</div>
								</div>
...
<div class="widget-box">
					...
					<div class="row-fluid">
                        ...
                        <div class="row-fluid">
									<div class="span4"><?php $data = array('id' => 'undisonedesc', 'name' => 'undisonedesc', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "placeholder"=>"Description"); echo form_input($data, set_value('undisonedesc')); ?>
                                 <?php echo form_error('undisonedesc', '<div class="alert alert-danger">', '</div>'); ?></div>
									<div class="span4"><?php $data = array('id' => 'undismale', 'name' => 'undismale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "placeholder"=>"Male"); echo form_input($data, set_value('undismale')); ?>
                              <?php echo form_error('undismale', '<div class="alert alert-danger">', '</div>'); ?></div>
                                    <div class="span4"><?php $data = array('id' => 'undisfemale', 'name' => 'undisfemale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "placeholder"=>"Female"); echo form_input($data, set_value('undisfemale')); ?>
                              <?php echo form_error('undisfemale', '<div class="alert alert-danger">', '</div>'); ?></div>
						</div>
                        <hr>
                         <div class="row-fluid">
									<div class="span4"><?php $data = array('id' => 'undissecdesc', 'name' => 'undissecdesc', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "placeholder"=>"Description"); echo form_input($data, set_value('undissecdesc')); ?>
                                 <?php echo form_error('undissecdesc', '<div class="alert alert-danger">', '</div>'); ?></div>
									<div class="span4"><?php $data = array('id' => 'undismaletwo', 'name' => 'undismaletwo', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "placeholder"=>"Male"); echo form_input($data, set_value('undismaletwo')); ?>
                              <?php echo form_error('undismaletwo', '<div class="alert alert-danger">', '</div>'); ?></div>
                                    <div class="span4"><?php $data = array('id' => 'undisfemaletwo', 'name' => 'undisfemaletwo', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "placeholder"=>"Female"); echo form_input($data, set_value('undisfemaletwo')); ?>
                        ...
                        <div class="row-fluid">
									...
									<div class="span4"><?php $data = array('id' => 'ocmale', 'name' => 'ocmale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "placeholder"=>"Male"); echo form_input($data, set_value('ocmale')); ?>
                              <?php echo form_error('ocmale', '<div class="alert alert-danger">', '</div>'); ?></div>
                                    <div class="span4"><?php $data = array('id' => 'ocfemale', 'name' => 'ocfemale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')", "placeholder"=>"Female"); echo form_input($data, set_value('ocfemale')); ?>
                        ...
                        <div class="row-fluid">
									...
									<div class="span4"><?php $data = array('id' => 'total_consultations', 'name' => 'total_consultations', 'readonly'=>'readonly'); echo form_input($data, set_value('total_consultations')); ?></div>
...
<div class="control-group"><label class="control-label" for="form-field-1">Slides/RDT examined: </label><div class="controls"><?php $data = array('id' => 'sre', 'name' => 'sre', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('sre')); ?>
                              <?php echo form_error('sre', '<div class="alert alert-danger">', '</div>'); ?></div>
</div>

<div class="control-group"><label class="control-label" for="form-field-1">Falciparum positive: </label><div class="controls"><?php $data = array('id' => 'pf', 'name' => 'pf', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('pf')); ?>
                              <?php echo form_error('pf', '<div class="alert alert-danger">', '</div>'); ?></div>
</div>

<div class="control-group"><label class="control-label" for="form-field-1">Vivax positive: </label><div class="controls"><?php $data = array('id' => 'pv', 'name' => 'pv', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('pv')); ?>
                              <?php echo form_error('pv', '<div class="alert alert-danger">', '</div>'); ?></div>
</div>

<div class="control-group"><label class="control-label" for="form-field-1">Mixed Positive: </label><div class="controls"><?php $data = array('id' => 'pmix', 'name' => 'pmix', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('pmix')); ?>
