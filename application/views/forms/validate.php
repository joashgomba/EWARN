					...
					<div class="main-content">
						<!--.breadcrumb--><div class="breadcrumbs" id="breadcrumbs">
							<ul class="breadcrumb">
								...
								<li class="active">Validate Form</li>
							</ul><!--.breadcrumb-->
...
<div class="control-group"><label class="control-label" for="form-field-1">Gender: </label><div class="controls">
