...
<div class="widget-box">
					...
					<div class="row-fluid">
                       ...
                       <div class="control-group">
									<label class="control-label" for="form-field-5"><?php echo $list->disease_name;?> &lt; 5</label>

									<div class="controls">
										<input class="span5" type="text" name="<?php echo $list->disease_code;?>_ufive_male" id="<?php echo $list->disease_code;?>_ufive_male" value="<?php echo $list->male_under_five; ?>"   onkeypress="return isNumberKey(event)" maxlength="2" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Male" onClick="checkvalid()" />
										<input class="span5" type="text" name="<?php echo $disease->disease_code;?>_ufive_female" id="<?php echo $list->disease_code;?>_ufive_female"  value="<?php echo $list->female_under_five; ?>" onKeyPress="return isNumberKey(event)" maxlength="2" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Female" />
                                        
                                        <span class="help-button" data-rel="popover" data-trigger="hover" data-placement="left" data-content="<?php echo $list->case_definition;?>." title="Case definition">?</span>
									</div>
								</div>
                                 ...
                                 <div class="control-group">
									...
									<div class="controls">
										<input class="span5" type="text" name="<?php echo $list->disease_code;?>_ofive_male" id="<?php echo $list->disease_code;?>_ofive_male" value="<?php echo $list->male_over_five; ?>" onKeyPress="return isNumberKey(event)" maxlength="5" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Male" />
										<input class="span5" type="text" name="<?php echo $list->disease_code;?>_ofive_female" id="<?php echo $list->disease_code;?>_ofive_female" value="<?php echo $list->female_over_five; ?>" onKeyPress="return isNumberKey(event)" maxlength="5" onFocus="change(this,'#FF0000','#FFCCFF','#000000'),checkvalid()" onBlur="change(this,'','','')" placeholder="Female" />
									</div>
								</div>
...
<div class="widget-box">
					...
					<div class="row-fluid">
                        ...
                        <div class="row-fluid">
									...
									<div class="span4"><?php $data = array('id' => 'total_consultations', 'name' => 'total_consultations','value'=>$row->total_consultations, 'readonly'=>'readonly'); echo form_input($data, set_value('total_consultations')); ?></div>
                                    <div class="span4">
                                   &nbsp;
                                    </div>
						</div>
...
<div class="control-group"><label class="control-label" for="form-field-1">Slides/RDT examined: </label><div class="controls"><?php $data = array('id' => 'sre', 'name' => 'sre', 'value'=>$row->sre,'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('sre')); ?>
                              <?php echo form_error('sre', '<div class="alert alert-danger">', '</div>'); ?></div>
</div>

<div class="control-group"><label class="control-label" for="form-field-1">Falciparum positive: </label><div class="controls"><?php $data = array('id' => 'pf', 'name' => 'pf', 'value'=>$row->pf, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('pf')); ?>
                              <?php echo form_error('pf', '<div class="alert alert-danger">', '</div>'); ?></div>
</div>

<div class="control-group"><label class="control-label" for="form-field-1">Vivax positive: </label><div class="controls"><?php $data = array('id' => 'pv', 'name' => 'pv', 'value'=>$row->pv, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('pv')); ?>
                              <?php echo form_error('pv', '<div class="alert alert-danger">', '</div>'); ?></div>
</div>

<div class="control-group"><label class="control-label" for="form-field-1">Mixed Positive: </label><div class="controls"><?php $data = array('id' => 'pmix', 'name' => 'pmix', 'value'=>$row->pmix, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('pmix')); ?>
