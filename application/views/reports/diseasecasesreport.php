			...
			<div class="main-content">
				...
				<div class="page-content">
                    ...
                    <h3 class="header smaller lighter green">
										...
										Weekly Disease Cases from <?php echo $reporting_year;?>/<?php echo $from;?> - <?php echo $reporting_year2;?>/<?php echo $to;?>
									</h3>
...
$(function () {
    ...
    $(document).ready(function() {
        ...
        options = {
            ...
            title: {
                text: 'Weekly Disease Cases <?php echo $reporting_year;?> Week <?php echo $from;?> to <?php echo $reporting_year2;?> Week <?php echo $to;?>'
            },
            xAxis: {
            },
            yAxis: {
