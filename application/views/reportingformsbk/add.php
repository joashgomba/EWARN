...
function formatDate(d){
  ...
  document.write("<input type='text' readonly=''  name='reporting_date' id='form-input-readonly' value='" +today+ "'>")
                              ...
                              <tr>
                                <td valign="top" colspan="2">Suspected Diphtheria</td><td valign="top"><?php $data = array('id' => 'diphmale', 'name' => 'diphmale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('diphmale')); ?>
                              ...
                              <tr>
                                <td valign="top" colspan="2">Suspected Whooping Cough</td><td valign="top"><?php $data = array('id' => 'wcmale', 'name' => 'wcmale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('wcmale')); ?>
                               ...
                               <tr>
                                 <td valign="top" colspan="2">Suspected Measles</td><td valign="top"><?php $data = array('id' => 'measmale', 'name' => 'measmale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('measmale')); ?>
                              ...
                              <tr>
                               ...
                               <tr>
                                 <td valign="top" colspan="2">Acute Flaccid Paralysis</td><td valign="top"><?php $data = array('id' => 'afpmale', 'name' => 'afpmale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('afpmale')); ?>
                             ...
                             <tr>
                              ...
                              <tr><td valign="top" colspan="2">Suspected Viral Hemorrhagic Fever</td><td valign="top"><?php $data = array('id' => 'vhfmale', 'name' => 'vhfmale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('vhfmale')); ?>
                              ...
                              <?php echo form_error('malofivefemale', '<div class="alert alert-danger">', '</div>'); ?>
                               ...
                               <tr><td valign="top" colspan="2">Suspected Meningitis</td><td valign="top"><?php $data = array('id' => 'suspectedmenegitismale', 'name' => 'suspectedmenegitismale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('suspectedmenegitismale')); ?>
