...
<?php echo form_open('diseasecategories/edit_validate/'.$row->id,$attributes); ?>
<div class="control-group"><label>Category name: </label><div class="controls"><?php $data = array('id' => 'category_name', 'name' => 'category_name', 'value' => $row->category_name); echo form_input($data, set_value('category_name')); ?></div>
