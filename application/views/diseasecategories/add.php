...
<?php echo form_open('diseasecategories/add_validate',$attributes); ?>
<div class="control-group"><label class="control-label" for="form-field-1">Category name: </label><div class="controls"><?php $data = array('id' => 'category_name', 'name' => 'category_name'); echo form_input($data, set_value('category_name')); ?></div>
</div>									
