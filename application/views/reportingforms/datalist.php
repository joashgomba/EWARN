...
xmlhttp.open("GET","<?php echo base_url(); ?>index.php/datalist/validate/"+str+"/"+reporting_year+"/"+reporting_year2+"/"+from+"/"+to+"/"+district_id+"/"+healthfacility_id+"/"+gender,true);
xmlhttp.send();
}
...
xmlhttp.open("GET","<?php echo base_url(); ?>index.php/datalist/invalidate/"+str+"/"+reporting_year+"/"+reporting_year2+"/"+from+"/"+to+"/"+district_id+"/"+gender,true);
xmlhttp.send();
}
</script>
