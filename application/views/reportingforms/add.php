...
{
  iliofivefemale = parseInt(document.frm.iliofivefemale.value);
}
...
{
  undisonedesc = parseInt(document.frm.undisonedesc.value);
}
...
{
  undissecdesc = parseInt(document.frm.undissecdesc.value);
}
                          ...
                          <div class="alert alert-error">
                           ...
                           <table id="customers">
                               ...
                               <?php
								...
								?></td>
                               <td><?php echo $user_country->second_admin_level_label;?></td><td>
                               <?php
							   if(getRole() == 'SuperAdmin')
	 							{
									?>
							  ...
							  if($level != 3)
							  {
								  ?>
                               <tr>
                               <td><?php echo $user_country->third_admin_level_label;?></td><td>
                                <?php
