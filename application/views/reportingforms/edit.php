...
function formatDate(d){
  ...
  document.write("<input type='hidden' name='edit_date' id='edit_date' value='" +today+ "'>")
                              ...
                              <tr>
                                <td valign="top" colspan="2">Suspected Diphtheria &lt;5yr</td><td valign="top"><?php $data = array('id' => 'diphmale', 'name' => 'diphmale', 'value'=> $row->diphmale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('diphmale')); ?>
                                ...
                                <tr>
                                <td valign="top" colspan="2">Suspected Diphtheria &gt;5yr</td><td valign="top"><?php $data = array('id' => 'diphofivemale', 'name' => 'diphofivemale', 'value'=> $row->diphofivemale,'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('diphofivemale')); ?>
                                
                                <?php echo form_error('diphofivemale', '<div class="alert alert-danger">', '</div>'); ?>
                                </td><td valign="top"><?php $data = array('id' => 'diphofivefemale', 'name' => 'diphofivefemale', 'value'=> $row->diphofivefemale,'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('diphofivefemale')); ?>
                                <?php echo form_error('diphofivefemale', '<div class="alert alert-danger">', '</div>'); ?>
                                </td></tr>
                                
                                
                              <tr>
                                <td valign="top" colspan="2">Suspected Whooping Cough &lt;5yr</td><td valign="top"><?php $data = array('id' => 'wcmale', 'name' => 'wcmale', 'value'=> $row->wcmale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('wcmale')); ?>
                                ...
                                <tr>
                                <td valign="top" colspan="2">Suspected Whooping Cough &gt;5yr</td><td valign="top"><?php $data = array('id' => 'wcofivemale', 'name' => 'wcofivemale', 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', 'value'=> $row->wcofivemale, "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('wcofivemale')); ?>
                                <?php echo form_error('wcofivemale', '<div class="alert alert-danger">', '</div>'); ?>
                                </td><td valign="top"><?php $data = array('id' => 'wcofivefemale', 'name' => 'wcofivefemale', 'value'=> $row->wcofivefemale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('wcofivefemale')); ?>
                                <?php echo form_error('wcofivefemale', '<div class="alert alert-danger">', '</div>'); ?>
                                </td></tr>
                                
                                
                               <tr>
                                 <td valign="top" colspan="2">Suspected Measles &lt;5yr</td><td valign="top"><?php $data = array('id' => 'measmale', 'name' => 'measmale', 'value'=> $row->measmale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('measmale')); ?>
                                 ...
                                 <tr>
                                 <td valign="top" colspan="2">Suspected Measles &gt;5yr</td><td valign="top"><?php $data = array('id' => 'measofivemale', 'name' => 'measofivemale', 'value'=> $row->measofivemale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('measofivemale')); ?>
                                  <?php echo form_error('measofivemale', '<div class="alert alert-danger">', '</div>'); ?>
                                 </td><td valign="top"><?php $data = array('id' => 'measofivefemale', 'name' => 'measofivefemale', 'value'=> $row->measofivefemale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('measofivefemale')); ?>
                              ...
                              <tr>
                               ...
                               <tr>
                                 <td valign="top" colspan="2">Acute Flaccid Paralysis &lt;5yr</td><td valign="top"><?php $data = array('id' => 'afpmale', 'name' => 'afpmale', 'value'=> $row->afpmale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('afpmale')); ?>
                                 ...
                                 <tr>
                                 <td valign="top" colspan="2">Acute Flaccid Paralysis &gt;5yr</td><td valign="top"><?php $data = array('id' => 'afpofivemale', 'name' => 'afpofivemale', 'value'=> $row->afpofivemale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('afpofivemale')); ?>
                                 <?php echo form_error('afpofivemale', '<div class="alert alert-danger">', '</div>'); ?>
                                 </td><td valign="top"><?php $data = array('id' => 'afpofivefemale', 'name' => 'afpofivefemale', 'value'=> $row->afpofivefemale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('afpofivefemale')); ?>
                             ...
                             <tr>
                              ...
                              <?php echo form_error('malofivefemale', '<div class="alert alert-danger">', '</div>'); ?>
                               ...
                               <tr><td valign="top" colspan="2">Suspected Meningitis &gt;5yr</td><td valign="top"><?php $data = array('id' => 'suspectedmenegitisofivemale', 'name' => 'suspectedmenegitisofivemale', 'value'=> $row->suspectedmenegitisofivemale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('suspectedmenegitisofivemale')); ?>                             
                               <?php echo form_error('suspectedmenegitisofivemale', '<div class="alert alert-danger">', '</div>'); ?>
                               </td><td valign="top"><?php $data = array('id' => 'suspectedmenegitisofivefemale', 'name' => 'suspectedmenegitisofivefemale', 'value'=> $row->suspectedmenegitisofivefemale, 'onkeypress'=>'return isNumberKey(event)', 'maxlength'=>'5', "onfocus"=>"change(this,'#FF0000','#FFCCFF','#000000')", "onblur"=>"change(this,'','','')"); echo form_input($data, set_value('suspectedmenegitisofivefemale')); ?>
