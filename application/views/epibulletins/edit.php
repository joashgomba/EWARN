                                    ...
                                    <tr>
                                        <td valign="top"><p align="justify"><?php echo $row->highlight;?></p>
                                            ...
                                            <p><strong>Highlights Narrative</strong><br>
                                                <small>Any other narrative you would like to add on the highlight section including an image of the alerts map.<font color="#ff4500"><strong>If uploading an image make sure you resize it to atmost dimension of 600 by 400 pixels to avoid distorting the PDF produced.</strong></font> </small></p>
                                            ...
                                            <script>
                                                ...
                                                function sendFile(file) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function(url) {
                                                            console.log(url);
                                                            $('#interventions').summernote("insertImage",url);
