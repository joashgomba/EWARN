...
<script type="text/javascript">
    ...
    bkLib.onDomLoaded (function() {
        var editor = nicEditors.findEditor('interventions');
        editor.getElm().onkeyup = function() { nicCount(editor, 'mycounter1', 800); }
    })
    //]]
</script>
...
<script type="text/javascript">
    //<[!CDATA[
    bkLib.onDomLoaded (function() {
        var editor = nicEditors.findEditor('highlight_text');
        editor.getElm().onkeyup = function() { nicCount(editor, 'mycounter2', 740); }
    })
    //]]
</script>
                                                ...
                                                <tr>
                                                    <td valign="top"><p align="justify"><?php echo $row->highlight;?></p>
                                                       ...
                                                       <p><strong>Highlights Narrative</strong><br>
                                                            <small>Any other narrative you would like to add on the highlight section including an image of the alerts map or any other image/infograph.<font color="#ff4500"><strong>If uploading an image make sure you resize it to atmost 250 by 250 to avoid distorting the PDF produced.</strong></font> </small></p>

                                                        <textarea name="highlight_text" id="highlight_text"><?php echo $row->highlight_text; ?></textarea>
                                                        <p><b id='mycounter2'>740</b> characters remaining</p>
