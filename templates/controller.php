...
class {controller_name} extends CI_Controller {
	...
	function manage(){
	  ...
	  if (!$this->erkanaauth->try_session_login()) {
	   ...
	   $this->data['template'] = $this->common->loadtemplate();
	...
	$this->load->library('form_validation');    
        ...
        {
             $this->data['custom_error'] = (validation_errors() ? '<div class="alert info">'.validation_errors().'</div>' : false);
        ...
        {                            
			...
			{
				$this->data['custom_error'] = '<div class="alert info"><p>An Error Occured.</p></div>';
